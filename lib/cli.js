...
var make = require('../../neumake'), DataReader = require('buffered-reader').DataReader, argv = require('argh').argv;
...
if (!argv.hasOwnProperty('j')) {
    argv.max_number_of_jobs = 1;
}
...
reader.on('end', function () {
     ...
     * Get to work!
     */
    make.process(rules, goal, argv, function (success) {
